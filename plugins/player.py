...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 Ƥɭɘɑsɘ ❤️ Ɱɑŋʋɑɭɭy 🥀 Ʌɗɗ 💫 Ʌssɩsʈɑŋʈ 😔 Øɤ 🎸 Ƈøŋʈɑƈʈ ❤️ ʈø :@GIRLS_CRUSH_OUT_OF_RANGE 🥀** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/11bdf6a421ffb1b06d93d.jpg"
            ...
            [
                [
                        InlineKeyboardButton(
                            text="✦𝐉𝐎𝐈𝐍 𝐅𝐎𝐑 𝐒𝐔𝐏𝐏𝐎𝐑𝐓✦",
                            url=f"https://t.me/Unique_society_Fearless_clan")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/11bdf6a421ffb1b06d93d.jpg", 
                             caption="**💥 ƁӇƛƬƛƘƬƖ 🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 ƁӇƛƬƛƘƬƖ 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
